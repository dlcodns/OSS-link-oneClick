...
#원클릭 넣을 이미지라벨
label=tkinter.Label(window,text="ccc",width=200, height=105,relief="solid")
label.pack()
...
#주소모음 버튼
b1=tkinter.Button(window, text="충북대학교\n홈페이지",bg="white", font=font,command=createLoginWindow)
b2=tkinter.Button(window, text="충북대학교\n씨앗",bg="white", font=font,command=createLoginWindow)
b3=tkinter.Button(window, text="충북대학교\n학생생활관",bg="white", font=font,command=createLoginWindow)
b4=tkinter.Button(window, text="충북대학교\necampus",bg="white", font=font,command=createLoginWindow)
b5=tkinter.Button(window, text="충북대학교\n개신누리",bg="white", font=font,command=createLoginWindow)
b6=tkinter.Button(window, text="충북대학교\n취업지원본부",bg="white", font=font,command=createLoginWindow)
